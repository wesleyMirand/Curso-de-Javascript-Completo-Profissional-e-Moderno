...
cursos.push("c++")    //push , pop  quer podem armazenar add ou tirar elementos no array, add no final.
cursos.unshift("python") //permite adicionar no começo da lista
cursos.shift() //tira do inicio e tira da lista
