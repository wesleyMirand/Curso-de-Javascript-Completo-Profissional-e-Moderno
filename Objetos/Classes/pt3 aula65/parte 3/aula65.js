 ...
 */
 ...
 const s_json_pessoa = JSON.stringify (pessoa) //Stringfy converte objeto em string JSON
 const o_json_pessoa = JSON.parse (s_json_pessoa) //Parse conver string json em objeto
